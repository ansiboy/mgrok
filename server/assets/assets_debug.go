...
// assetsServerDs_store reads file data from disk. It returns an error on failure.
func assetsServerDs_store() (*asset, error) {
	path := "/Volumes/data/projects/mgrok/assets/server/.DS_Store"
	name := "assets/server/.DS_Store"
...
func assetsServerTlsSnakeoilCrt() (*asset, error) {
	path := "/Volumes/data/projects/mgrok/assets/server/tls/snakeoil.crt"
...
func assetsServerTlsSnakeoilKey() (*asset, error) {
	path := "/Volumes/data/projects/mgrok/assets/server/tls/snakeoil.key"
